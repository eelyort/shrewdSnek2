...
class SiblingRunner{
    ...
    constructor(snakesIn, numReturn, numRuns, callback, scoringFunction, modeIn = 0) {
        ...
        for(let i = 0; i < this.runners.length; i++){
            this.runners[i] = [new SpeciesRunner(snakesIn[i], numRuns, this.callback.bind(this), scoringFunction, modeIn), 0];
        }
